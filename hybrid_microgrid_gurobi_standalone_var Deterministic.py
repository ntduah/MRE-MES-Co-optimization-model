...
#                  quicksum(para.gamma_B * abs(b_x[t]) + para.gamma_Q * abs(q_x[t]) + para.gamma_H * abs(h_x[t]) + para.gamma_W * abs(w_x[t]) for t in range(para.Time_period)))
    ...
    # model.addConstr(gp.quicksum(rPow[t] for t in range(para.Time_period)) == 0.2*(gp.quicksum(rPow[t] for t in range(para.Time_period)) + gp.quicksum(pGT[t] for t in range(para.Time_period))))
    ...
    workbook0 = xlsxwriter.Workbook('MES_result_gurobi_standalone__optimal_unlimit_PV_hydro_water_stor.xlsx')
    ...
    for t in range(para.Time_period):
        ...
        worksheet0_1.write(0, t, b_x[t].X)
        worksheet0_2.write(0, t, q_x[t].X)
        worksheet0_3.write(0, t, w_x[t].X)
        worksheet0_4.write(0, t, h_x[t].X)
        worksheet0_5.write(0, t, b_xd[t].X)
        worksheet0_6.write(0, t, b_xc[t].X)
        worksheet0_7.write(0, t, q_xd[t].X)
        worksheet0_8.write(0, t, q_xc[t].X)
        worksheet0_9.write(0, t, w_xd[t].X)
        worksheet0_10.write(0, t, w_xc[t].X)
        worksheet0_11.write(0, t, h_xd[t].X)
        worksheet0_12.write(0, t, h_xc[t].X)   
        worksheet0_13.write(0, t, rPow[t].X)
        worksheet0_14.write(0, t, wFlow[t].X)
        worksheet0_15.write(0, t, eP_des[t].X)
        worksheet0_16.write(0, t, q1GT[t].X)
        worksheet0_17.write(0, t, q2GT[t].X)
        worksheet0_18.write(0, t, pGT[t].X)
        worksheet0_19.write(0, t, gFlowP[t].X)
        worksheet0_20.write(0, t, gFlowB[t].X)
        worksheet0_21.write(0, t, hFlow[t].X)
        worksheet0_22.write(0, t, eP_eltz[t].X)   
        worksheet0_23.write(0, t, sB[t].X)
        worksheet0_24.write(0, t, sQ[t].X)
        worksheet0_25.write(0, t, sW[t].X)
        worksheet0_26.write(0, t, sH[t].X) 

        worksheet0_56.write(0, t, pWind[t].X)
        worksheet0_57.write(0, t, pSolar[t].X)
        worksheet0_58.write(0, t, pWave[t].X) 
        worksheet0_61.write(0, t, ds_water[t].X)
